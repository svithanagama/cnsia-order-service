...
import me.sanjayav.polarbookshop.orderservice.order.event.OrderDispatchedMessage;
...
public class OrderService {
  ...
  public Mono<Order> submitOrder(String isbn, int quantity) {
    return bookClient.getBookByIsbn(isbn)
        ...
        .doOnNext(this::publishOrderAcceptedMessage);
  }
  ...
  private void publishOrderAcceptedMessage(Order order) {
    ...
    var orderAcceptedMessage = new OrderDispatchedMessage(order.id());
    streamBridge.send("orderAccepted", order);
